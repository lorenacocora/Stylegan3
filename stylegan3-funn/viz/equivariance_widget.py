    ...
    def __call__(self, show=True):
        ...
        if show:
            ...
            with imgui_utils.item_width(-1 - viz.button_w - viz.spacing), imgui_utils.grayed_out(not self.xlate.anim):
                ...
                # changed, speed = imgui.slider_float('##xlate_speed', self.xlate.speed, 0, 0.5, format='Speed %.5f', flags=imgui.SLIDER_FLAGS_NONE)
                if changed:
        ...
        if show:
            ...
            with imgui_utils.item_width(-1 - viz.button_w - viz.spacing), imgui_utils.grayed_out(not self.rotate.anim):
                ...
                # changed, speed = imgui.slider_float('##rotate_speed', self.rotate.speed, -1, 1, format='Speed %.4f', flags=imgui.SLIDER_FLAGS_NONE)
                if changed:
        ...
        if show:
            ...
            with imgui_utils.item_width(-1 - viz.button_w - viz.spacing), imgui_utils.grayed_out(not self.scale.anim):
                ...
                # changed, speed = imgui.slider_float('##scale_speed', self.scale.speed, 0, 0.5, format='Speed %.5f', flags=imgui.SLIDER_FLAGS_NONE)
                if changed:
        ...
        if show:
            ...
            with imgui_utils.item_width(-1 - viz.button_w - viz.spacing), imgui_utils.grayed_out(not self.shear.anim):
                ...
                # changed, speed = imgui.slider_float('##shear_speed', self.shear.speed, 0, 0.5, format='Speed %.5f', flags=imgui.SLIDER_FLAGS_NONE)
                if changed:
